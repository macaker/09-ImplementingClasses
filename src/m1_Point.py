...
class Point():
    ...
    def __repr__(self):
        ...
        #Eddie Mannan helped me with the above line
    ...
    def get_distance_from(self, point):
        s = (self.x - point.x)**2 + (self.y - point.y)**2
        return s**(.5)

    def get_distance_from_start(self):
        d = (self.origionalx - self.x)**2 + (self.origionaly - self.y)**2
        return d**(.5)
    ...
    def closer_to(self, point2, point3):
        distance2 = self.get_distance_from(Point(point2.x - self.x, point2.y - self.y))
        distance3 = self.get_distance_from(Point(point3.x - self.x, point3.y - self.y))
